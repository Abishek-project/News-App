...
class ArticleView extends StatelessWidget {
            ...
            body: Column(
              ...
              children: [
                Padding(
                  ...
                  child: appBarView(context),
                ),
                articleImageView(article),
                bottomDetailsWidget(context, article),
              ],
            )),
      ),
    );
  ...
  Align bottomDetailsWidget(BuildContext context, Article article) {
    return Align(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text("378", style: AppTypography.regularFootNote02),
                        ],
                      ),
                    )
                  ],
  ...
  Expanded articleImageView(Article article) {
    return Expanded(
      child: Padding(
        padding: const EdgeInsets.only(left: 16, right: 16),
        child: Column(
  ...
  IconButton appBarView(BuildContext context) {
    return IconButton(
      icon: Icon(
        Icons.arrow_back,
        color: AppColors.appWhite,
